...
from tests.factories import CategoryFactory, ProductTypeFactory, ProductSpecificationFactory, ProductFactory, ProductSpecificationValueFactory
...
@pytest.fixture
def ProductSpecification(db, product_specification_factory):
